...
Namespace Spreadsheet_Document_Api_Part_3
    ...
    Public MustInherit Class ExampleCodeEvaluator
        ...
        Public Function ExcecuteCodeAndGenerateDocument(ByVal args As Spreadsheet_Document_Api_Part_3.CodeEvaluationEventArgs) As Boolean
    ...
    Public Class CodeExampleGroup
        ...
        Public Property Examples As List(Of Spreadsheet_Document_Api_Part_3.CodeExample)

        Public Property Id As Integer

        Friend Sub Merge(ByVal n As Spreadsheet_Document_Api_Part_3.CodeExampleGroup)
    ...
    Public Class CodeExample
        ...
        Friend Sub Merge(ByVal n As Spreadsheet_Document_Api_Part_3.CodeExample)
...
#Region "CodeExampleDemoUtils"
    Public Module CodeExampleDemoUtils
        ...
        Public Function GatherExamplesFromProject(ByVal examplesPath As String, ByVal language As Spreadsheet_Document_Api_Part_3.ExampleLanguage) As Dictionary(Of String, System.IO.FileInfo)
            ...
            For Each fileName As String In System.IO.Directory.GetFiles(examplesPath, "*" & Spreadsheet_Document_Api_Part_3.CodeExampleDemoUtils.GetCodeExampleFileExtension(language))
        ...
        Public Function GetCodeExampleFileExtension(ByVal language As Spreadsheet_Document_Api_Part_3.ExampleLanguage) As String
            If language = Spreadsheet_Document_Api_Part_3.ExampleLanguage.VB Then Return ".vb"
            Return ".cs"
        End Function
        ...
        Public Function ConvertStringToMoreHumanReadableForm(ByVal exampleName As String) As String
            Dim result As String = Spreadsheet_Document_Api_Part_3.CodeExampleDemoUtils.SplitCamelCase(exampleName)
        ...
        Public Function GetExamplePath(ByVal exampleFolderName As String) As String '"CodeExamples"
            ...
            Dim examplesPathInInsallation As String = Spreadsheet_Document_Api_Part_3.CodeExampleDemoUtils.GetRelativeDirectoryPath(exampleFolderName)
        ...
        Public Function FindExamples(ByVal examplePath As String, ByVal examplesCS As System.Collections.Generic.Dictionary(Of String, System.IO.FileInfo), ByVal examplesVB As System.Collections.Generic.Dictionary(Of String, System.IO.FileInfo)) As List(Of Spreadsheet_Document_Api_Part_3.CodeExampleGroup)
            Dim result As System.Collections.Generic.List(Of Spreadsheet_Document_Api_Part_3.CodeExampleGroup) = New System.Collections.Generic.List(Of Spreadsheet_Document_Api_Part_3.CodeExampleGroup)()
            Dim current As System.Collections.Generic.Dictionary(Of String, System.IO.FileInfo) = Nothing
            Dim csExampleFinder As Spreadsheet_Document_Api_Part_3.ExampleFinder
            Dim vbExampleFinder As Spreadsheet_Document_Api_Part_3.ExampleFinder
            If examplesCS.Count = 0 Then
                current = examplesVB
                csExampleFinder = Nothing
                vbExampleFinder = New Spreadsheet_Document_Api_Part_3.ExampleFinderVB()
            ElseIf examplesVB.Count = 0 Then
                current = examplesCS
                csExampleFinder = New Spreadsheet_Document_Api_Part_3.ExampleFinderCSharp()
            ...
            For Each sourceCodeItem As System.Collections.Generic.KeyValuePair(Of String, System.IO.FileInfo) In current
                ...
                Dim foundExamplesCS As System.Collections.Generic.List(Of Spreadsheet_Document_Api_Part_3.CodeExample) = New System.Collections.Generic.List(Of Spreadsheet_Document_Api_Part_3.CodeExample)()
                If csExampleFinder IsNot Nothing Then foundExamplesCS = csExampleFinder.Process(examplesCS(key))
                Dim foundExamplesVB As System.Collections.Generic.List(Of Spreadsheet_Document_Api_Part_3.CodeExample) = New System.Collections.Generic.List(Of Spreadsheet_Document_Api_Part_3.CodeExample)()
                If vbExampleFinder IsNot Nothing Then foundExamplesVB = vbExampleFinder.Process(examplesVB(key))
                Dim mergedExamples As System.Collections.Generic.List(Of Spreadsheet_Document_Api_Part_3.CodeExample) = New System.Collections.Generic.List(Of Spreadsheet_Document_Api_Part_3.CodeExample)()
                ...
                ElseIf(foundExamplesCS.Count = foundExamplesVB.Count) Then
                    mergedExamples = Spreadsheet_Document_Api_Part_3.CodeExampleDemoUtils.MergeExamples(foundExamplesCS, foundExamplesVB)
                End If

                If mergedExamples.Count = 0 Then Continue For
                Dim group As Spreadsheet_Document_Api_Part_3.CodeExampleGroup = New Spreadsheet_Document_Api_Part_3.CodeExampleGroup() With {.Name = mergedExamples(CInt((0))).HumanReadableGroupName, .Examples = mergedExamples}
                result.Add(group)
            Next
        ...
        Private Function MergeExamples(ByVal foundExamplesCS As System.Collections.Generic.List(Of Spreadsheet_Document_Api_Part_3.CodeExample), ByVal foundExamplesVB As System.Collections.Generic.List(Of Spreadsheet_Document_Api_Part_3.CodeExample)) As List(Of Spreadsheet_Document_Api_Part_3.CodeExample)
            Dim result As System.Collections.Generic.List(Of Spreadsheet_Document_Api_Part_3.CodeExample) = New System.Collections.Generic.List(Of Spreadsheet_Document_Api_Part_3.CodeExample)()
            Dim count As Integer = foundExamplesCS.Count
            For i As Integer = 0 To count - 1
                Dim itemCS As Spreadsheet_Document_Api_Part_3.CodeExample = foundExamplesCS(i)
                Dim itemVB As Spreadsheet_Document_Api_Part_3.CodeExample = foundExamplesVB(i)
                If Equals(itemCS.HumanReadableGroupName, itemVB.HumanReadableGroupName) AndAlso Equals(itemCS.RegionName, itemVB.RegionName) Then
                    Dim merged As Spreadsheet_Document_Api_Part_3.CodeExample = New Spreadsheet_Document_Api_Part_3.CodeExample()
        ...
        Public Function DetectExampleLanguage(ByVal solutionFileNameWithoutExtenstion As String) As ExampleLanguage
            ...
            If csproject.Length <> 0 AndAlso csproject(CInt((0))).EndsWith(solutionFileNameWithoutExtenstion & ".csproj") Then Return Spreadsheet_Document_Api_Part_3.ExampleLanguage.Csharp
            Dim vbproject As String() = System.IO.Directory.GetFiles(projectPath, "*.vbproj")
            If vbproject.Length <> 0 AndAlso vbproject(CInt((0))).EndsWith(solutionFileNameWithoutExtenstion & ".vbproj") Then Return Spreadsheet_Document_Api_Part_3.ExampleLanguage.VB
            Return Spreadsheet_Document_Api_Part_3.ExampleLanguage.Csharp
        End Function
    End Module
...
#Region "ExampleFinder"
    Public MustInherit Class ExampleFinder
        ...
        Public Function Process(ByVal fileWithExample As System.IO.FileInfo) As List(Of Spreadsheet_Document_Api_Part_3.CodeExample)
            If fileWithExample Is Nothing Then Return New System.Collections.Generic.List(Of Spreadsheet_Document_Api_Part_3.CodeExample)()
            ...
            Dim foundExamples As System.Collections.Generic.List(Of Spreadsheet_Document_Api_Part_3.CodeExample) = Me.ParseSourceFileAndFindRegionsWithExamples(groupName, code)
            Return foundExamples
        End Function

        ' todo: remove example group
        Public Function ParseSourceFileAndFindRegionsWithExamples(ByVal groupName As String, ByVal sourceCode As String) As List(Of Spreadsheet_Document_Api_Part_3.CodeExample)
            Dim result As System.Collections.Generic.List(Of Spreadsheet_Document_Api_Part_3.CodeExample) = New System.Collections.Generic.List(Of Spreadsheet_Document_Api_Part_3.CodeExample)()
        ...
        Protected Function CreateSpreadsheetExample(ByVal exampleGroup As String, ByVal regionName As String, ByVal exampleCode As String) As CodeExample
            Dim result As Spreadsheet_Document_Api_Part_3.CodeExample = New Spreadsheet_Document_Api_Part_3.CodeExample()
            Me.SetExampleCode(exampleCode, result)
            result.RegionName = regionName
            result.HumanReadableGroupName = Spreadsheet_Document_Api_Part_3.CodeExampleDemoUtils.ConvertStringToMoreHumanReadableForm(exampleGroup)
            Return result
        End Function

        Protected MustOverride Sub SetExampleCode(ByVal exampleCode As String, ByVal newExample As Spreadsheet_Document_Api_Part_3.CodeExample)

        Protected Overridable Function DeleteLeadingWhiteSpacesFromSourceCode(ByVal lines As String()) As String()
            Return Spreadsheet_Document_Api_Part_3.CodeExampleDemoUtils.DeleteLeadingWhiteSpaces(lines, "            ")
        End Function
        ...
        Protected Overridable Function ValidateRegionName(ByVal lines As String(), ByRef regionName As String) As Boolean
            ...
            regionName = Spreadsheet_Document_Api_Part_3.CodeExampleDemoUtils.ConvertStringToMoreHumanReadableForm(region.Substring(regionIndex + Me.RegionStarts.Length + keepHashMark))
            Return True
        End Function
    End Class
...
#Region "ExampleFinderVB"
    Public Class ExampleFinderVB
        Inherits Spreadsheet_Document_Api_Part_3.ExampleFinder
        ...
        Protected Overrides Function DeleteLeadingWhiteSpacesFromSourceCode(ByVal lines As String()) As String()
            ...
            Return Spreadsheet_Document_Api_Part_3.CodeExampleDemoUtils.DeleteLeadingWhiteSpaces(result, Global.Microsoft.VisualBasic.Constants.vbTab & Global.Microsoft.VisualBasic.Constants.vbTab & Global.Microsoft.VisualBasic.Constants.vbTab)
        End Function
        ...
        Protected Overrides Sub SetExampleCode(ByVal code As String, ByVal newExample As Spreadsheet_Document_Api_Part_3.CodeExample)
...
#Region "LeakSafeCompileEventRouter"
    Public Class LeakSafeCompileEventRouter
        ...
        Public Sub New(ByVal [module] As Spreadsheet_Document_Api_Part_3.ExampleEvaluatorByTimer)
        ...
        Public Sub OnCompileExampleTimerTick(ByVal sender As Object, ByVal e As System.EventArgs)
            Dim [module] As Spreadsheet_Document_Api_Part_3.ExampleEvaluatorByTimer = CType(Me.weakControlRef.Target, Spreadsheet_Document_Api_Part_3.ExampleEvaluatorByTimer)
    ...
    Public Delegate Sub CodeEvaluationEventHandler(ByVal sender As Object, ByVal e As Spreadsheet_Document_Api_Part_3.CodeEvaluationEventArgs)
    ...
    Public Delegate Sub OnAfterCompileEventHandler(ByVal sender As Object, ByVal e As Spreadsheet_Document_Api_Part_3.OnAfterCompileEventArgs)

#End Region
    Public MustInherit Class ExampleEvaluatorByTimer
        Implements System.IDisposable

        Private leakSafeCompileEventRouter As Spreadsheet_Document_Api_Part_3.LeakSafeCompileEventRouter
        ...
        Public Sub New(ByVal enableTimer As Boolean)
            Me.leakSafeCompileEventRouter = New Spreadsheet_Document_Api_Part_3.LeakSafeCompileEventRouter(Me)
            'this.compileExampleTimer = new System.Windows.Forms.Timer();
            If enableTimer Then
                Me.compileExampleTimer = New System.Windows.Forms.Timer()
                Me.compileExampleTimer.Interval = Spreadsheet_Document_Api_Part_3.ExampleEvaluatorByTimer.CompileTimeIntervalInMilliseconds
...
#Region "Events"
        Public Event QueryEvaluate As Spreadsheet_Document_Api_Part_3.CodeEvaluationEventHandler
        ...
        Protected Friend Overridable Function RaiseQueryEvaluate() As CodeEvaluationEventArgs
            If QueryEvaluateEvent IsNot Nothing Then
                Dim args As Spreadsheet_Document_Api_Part_3.CodeEvaluationEventArgs = New Spreadsheet_Document_Api_Part_3.CodeEvaluationEventArgs()
        ...
        Public Event OnAfterCompile As Spreadsheet_Document_Api_Part_3.OnAfterCompileEventHandler
        ...
        Private Sub RaiseOnAfterCompile(ByVal result As Boolean)
            RaiseEvent OnAfterCompile(Me, New Spreadsheet_Document_Api_Part_3.OnAfterCompileEventArgs() With {.Result = result})
        End Sub

#End Region
        Public Sub CompileExample(ByVal sender As Object, ByVal e As System.EventArgs)
            If Not Me.compileComplete Then Return
            Dim args As Spreadsheet_Document_Api_Part_3.CodeEvaluationEventArgs = Me.RaiseQueryEvaluate()
            If Not args.Result Then Return
            Me.ForceCompile(args)
        End Sub

        Public Sub ForceCompile(ByVal args As Spreadsheet_Document_Api_Part_3.CodeEvaluationEventArgs)
        ...
        Private Sub CompileExampleAndShowPrintPreview(ByVal args As Spreadsheet_Document_Api_Part_3.CodeEvaluationEventArgs)
        ...
        Public Function Evaluate(ByVal args As Spreadsheet_Document_Api_Part_3.CodeEvaluationEventArgs) As Boolean
            Dim spreadsheetExampleCodeEvaluator As Spreadsheet_Document_Api_Part_3.ExampleCodeEvaluator = Me.GetExampleCodeEvaluator(args.Language)
            Return spreadsheetExampleCodeEvaluator.ExcecuteCodeAndGenerateDocument(args)
        End Function

        Protected MustOverride Function GetExampleCodeEvaluator(ByVal language As Spreadsheet_Document_Api_Part_3.ExampleLanguage) As ExampleCodeEvaluator
