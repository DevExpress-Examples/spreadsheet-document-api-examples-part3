...
'INSTANT VB NOTE: The variable codeStart was renamed since Visual Basic does not allow variables and other class members to have the same name:
		Private Const codeStart_Renamed As String = "using System;" & ControlChars.CrLf & "using DevExpress.Spreadsheet;" & ControlChars.CrLf & "using DevExpress.Spreadsheet.Charts;" & ControlChars.CrLf & "using DevExpress.Spreadsheet.Drawings;" & ControlChars.CrLf & "using DevExpress.XtraSpreadsheet.Export;" & ControlChars.CrLf & "using System.Drawing;" & ControlChars.CrLf & "using System.Windows.Forms;" & ControlChars.CrLf & "using DevExpress.XtraPrinting;" & ControlChars.CrLf & "using DevExpress.XtraPrinting.Control;" & ControlChars.CrLf & "using DevExpress.Utils;" & ControlChars.CrLf & "using System.IO;" & ControlChars.CrLf & "using System.Diagnostics;" & ControlChars.CrLf & "using System.Xml;" & ControlChars.CrLf & "using System.Data;" & ControlChars.CrLf & "using System.Linq;" & ControlChars.CrLf & "using System.Collections.Generic;" & ControlChars.CrLf & "using System.Globalization;" & ControlChars.CrLf & "using Formatting = DevExpress.Spreadsheet.Formatting;" & ControlChars.CrLf & "namespace SpreadsheetCodeResultViewer { " & ControlChars.CrLf & "public class ExampleItem { " & ControlChars.CrLf & "        public static void Process(Workbook workbook) { " & ControlChars.CrLf & ControlChars.CrLf
...
'INSTANT VB NOTE: The variable codeEnd was renamed since Visual Basic does not allow variables and other class members to have the same name:
    ...
    Partial Public Class SpreadsheetVbExampleCodeEvaluator
		...
		End Function
		'INSTANT VB NOTE: The variable codeStart was renamed since Visual Basic does not allow variables and other class members to have the same name:
		Private Const codeStart_Renamed As String = "Imports Microsoft.VisualBasic" & ControlChars.CrLf & "Imports System" & ControlChars.CrLf & "Imports DevExpress.Spreadsheet" & ControlChars.CrLf & "Imports DevExpress.Spreadsheet.Charts" & ControlChars.CrLf & "Imports DevExpress.Spreadsheet.Drawings" & ControlChars.CrLf & "Imports DevExpress.XtraSpreadsheet.Export" & ControlChars.CrLf & "Imports System.Drawing" & ControlChars.CrLf & "Imports System.Windows.Forms" & ControlChars.CrLf & "Imports DevExpress.XtraPrinting" & ControlChars.CrLf & "Imports DevExpress.XtraPrinting.Control" & ControlChars.CrLf & "Imports DevExpress.Utils" & ControlChars.CrLf & "Imports System.IO" & ControlChars.CrLf & "Imports System.Diagnostics" & ControlChars.CrLf & "Imports System.Xml" & ControlChars.CrLf & "Imports System.Data" & ControlChars.CrLf & "Imports System.Collections.Generic" & ControlChars.CrLf & "Imports System.Globalization" & ControlChars.CrLf & "Imports System.Linq" & ControlChars.CrLf & "Imports Formatting = DevExpress.Spreadsheet.Formatting" & ControlChars.CrLf & "Namespace SpreadsheetCodeResultViewer" & ControlChars.CrLf & "	Public Class ExampleItem" & ControlChars.CrLf & "		Public Shared Sub Process(ByVal workbook As Workbook)" & ControlChars.CrLf & ControlChars.CrLf
